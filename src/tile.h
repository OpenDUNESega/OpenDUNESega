...
#define Tile_IsValid(tile) (((Tile_GetX(tile) | Tile_GetX(tile)) & 0xc000) == 0)
...
#define Tile_GetX(tile) ((uint16)(tile))
...
#define Tile_GetY(tile) ((uint16)((tile) >> 16))
...
#define Tile_GetPosX(tile) ((Tile_GetX(tile) >> 8) & 0x3f)
...
#define Tile_GetPosY(tile) ((Tile_GetY(tile) >> 8) & 0x3f)
...
*/
#define Tile_MakeXY(X, Y) (((X) & 0x3FFF) | ((Y) & 0x3FFF) << 16)
...
uint16 Tile_GetYProjection(tile32 tile, uint16 orientation, uint16 distance);
uint16 Tile_GetXProjection(tile32 tile, uint16 orientation, uint16 distance);
tile32 Tile_AddTileDiff(tile32 from, int16 diffX, int16 diffY);

uint16 Tile_GetPackedByDirection(uint16 packed_from, uint16 orientation);
