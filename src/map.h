 ...
 */
typedef struct Tile {
	/* 0000 01FF */ BIT_U16 groundTileID:9;             /*!< The "Icon" which is drawn on this Tile. */
	/* 0000 FE00 */ BIT_U16 overlayTileID:7;            /*!< The Overlay which is drawn over this Tile. */
	/* 0007 0000 */ BIT_U8 houseID:3;                  /*!< Which House owns this Tile. */
	/* 0008 0000 */ BIT_U8 /*2*//*3*/isUnveiled:1;               /*!< There is no fog on the Tile. */
	/* 0010 0000 */ BIT_U8 /*2*//*4*/hasUnit:1;                  /*!< There is a Unit on the Tile. */
	/* 0020 0000 */ BIT_U8 hasStructure:1;             /*!< There is a Structure on the Tile. */
	/* 0040 0000 */ BIT_U8 hasAnimation:1;             /*!< There is animation going on the Tile. */
	/* 0080 0000 */ BIT_U8 hasExplosion:1;             /*!< There is an explosion on the Tile. */
	/* FF00 0000 */ BIT_U8 /*3*/index;                    /*!< Index of the Structure / Unit (index 1 is Structure/Unit 0, etc). */
} Tile;
...
extern void Map_UpdateAround(uint16 radius, tile32 position, struct Unit *unit, uint32 function);
