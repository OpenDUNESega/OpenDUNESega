...
typedef struct Unit {
    ...
    /*0x60*/tile32 targetLast;                                      /*!< The last position of the Unit. Carry-alls will return the Unit here. */
    /*0x64*/tile32 targetPreLast;                                   /*!< The position before the last position of the Unit. */
    ...
    uint16 timer;                                           /*!< Timer used in animation, to count down when to do the next step. */
     int16 positionChangeX;
     int16 positionChangeY;
    uint8  route[16];                                       /*!< The current route the Unit is following. */
} Unit;
...
typedef struct UnitInfo {
    ...
    /*3A*/uint16 dimension;                                       /*!< The dimension of the Unit Sprite. */
    uint16 _padding;
    /*3E*/uint16 movementType;                                    /*!< MovementType of Unit. */
